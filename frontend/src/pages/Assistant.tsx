  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        {empty ? (
          <div className="animate-fade-in-up flex h-full flex-col items-center justify-center px-4 text-center">
            <div className="mb-5 rounded-2xl shadow-lg" style={{ boxShadow: '0 10px 28px rgba(79,70,229,.28)' }}>
              <BotAvatar size={64} />
            </div>
            <h2 className="font-display text-2xl font-extrabold tracking-tight text-navy">Ask {BOT_NAME} anything</h2>
      ...
      <form
        ...
        className="mt-3 flex items-center gap-2 rounded-2xl border border-line bg-surface p-2 shadow-sm focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/20"
      >
